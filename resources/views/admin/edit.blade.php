       ...
       <div class="">
         ...
         <div class="row">
           <div class="col-md-12 col-sm-12 col-xs-12">
             <div class="x_panel">
               ...
               <div class="x_content">
                @foreach($package_id as $packid)
                 <form class="form-horizontal form-label-left" novalidate action="{{ url('/edit/package'. $packid->id)}}">
                @endforeach
                   <div class="item form-group">
                     <label class="control-label col-md-3 col-sm-3 col-xs-12" for="contentname">Content Name <span class="required">*</span>
                     </label>
                     <div class="col-md-6 col-sm-6 col-xs-12">
                       <input id="contentname" name="contentname" class="form-control col-md-7 col-xs-12" required="required" type="text">
                     </div>
                   </div>
         ...
         <div class="row">
           <div class="col-md-12 col-sm-12 col-xs-12">
             <div class="x_panel">
               <div class="x_title">
                @foreach($package_id as $packname)
                 <h2>Package {{$packname->packagename}}<small> ₱ {{$packname->price}}.00</small></h2>
                 @endforeach
                 <ul class="nav navbar-right panel_toolbox">
                   <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                   </li>
               ...
               <div class="x_content">
                ...
                @foreach($packagecontent as $packcontent)
                             <span class="fa fa-circle"></span> <label class="control-label">{{$packcontent->contentname}}
                             </label><br>
                @endforeach
