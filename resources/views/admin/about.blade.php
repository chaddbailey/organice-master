...
<html lang="en">
  <head>
    ...
    <title>Service Partner - About</title>
       ...
       <div class="">
         ...
         <div class="row">
           <div class="col-md-12 col-sm-12 col-xs-12">
             <div class="x_panel">
               <div class="x_title">
                 <h2>Add About <small>sub title</small></h2>
               ...
               <div class="x_content">
                ...
                <div class="form-group label-floating">
                  ...
                  <form form enctype="multipart/form-data" action="{{ url('/add/desc') }}" > 
                  <textarea type="text" name="description" id="description" class="form-control" rows="5" value="">{{Auth::guard('admin')->user()->description}}</textarea>
