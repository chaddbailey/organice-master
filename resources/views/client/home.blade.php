          ...
          <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel tile fixed_height_100">
                  ...
                  <div class="x_content">
                  <h4>Here are your pending and accepted request from your selected service partners. Get updated! Thank you!</h4>
          ...
          <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel tile fixed_height_100">
                  ...
                  <h3>Your Events<small> List of your events</small></h3>

                    <div class="clearfix"></div>
                  </div>
                    
                @foreach($distinct as $dt)
                  <div class="x_content">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          <div class="x_panel tile fixed_height_100">
                            <div class="x_title">
                               ...
                               <h1 style="color: red;"><b>{{$dt->event}}</b></h1>
                             ...
                             @if($dt->event == $dp->event)
                              ...
                              <div class="col-md-4 col-sm-4 col-xs-12">
                                <div class="x_panel tile fixed_height_320">
                                    ...
                                    <div class="x_title">
                                      <h2><b>{{$dp->name}}</b></h2><br> 
                                      <label>{{$dp->status}}</label>
                                    </div>

                                      <td>Date and Time: <label>{{$dp->datetime}}</label></td><br>  
                                      <td>Name: <label>{{$dp->firstname .' '. $dp->lastname}}</label></td><br>
                                      <td>No. of Heads: </h5><label>{{$dp->heads}}</label></td><br>
                                      <td>Event: </h5><label>{{$dp->event}}</label></td><br>
                                      <td>Package: </h5><label>{{$dp->package}}</label></td><br>
                                      <td>Total Price: </h5><label>{{$dp->price}}</label></td><br>
